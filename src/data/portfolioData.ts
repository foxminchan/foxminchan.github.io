...
export const CERTIFICATIONS: Certification[] = [
  ...
  },
  {
    ...
    expires: 'Sep 2028',
    credentialId: '194584617',
    credentialUrl: 'https://certifications.asana.com/66bef4fa-69c2-4c69-a007-a9bce4031a8c',
    level: 'Specialty',
    featured: false,
    badgeImage: '/badges/asana-am.png',
  },
  {
    id: 34,
  ...
  },
  {
    ...
    expires: 'Sep 2027',
    credentialId: 'F018D8774A8E2C01',
    credentialUrl:
      'https://learn.microsoft.com/api/credentials/share/en-us/FoxMinChan/F018D8774A8E2C01?sharingId',
    level: 'Associate',
    featured: true,
    ...
    projects: [
      {
        ...
        points: [
          'Contributed to the end-to-end migration of **23 VM-hosted microservices to ACA**, authoring **3+ ADRs** and implementing **configuration-driven environment switching** across deployment environments.',
          'Served as the **primary vendor technical liaison**, presenting **Azure landing zone architecture proposals** to the client’s Solution Architect, Engineering Manager, Tech Leads, and DevOps engineers.',
          'Expanded responsibilities from backend engineering into **cloud infrastructure and platform engineering**, working with **ACAs, K8s, Helm, Istio, NGINX, and Kafka** across application deployment and service-integration workloads.',
          'Maintained **zero critical or blocker production defects** by enforcing **Definition of Done standards, automated quality gates**, disciplined code reviews, and release-readiness practices, contributing to an **82/100 Sprint Health Score**.',
          'Modernized repository and delivery workflows through **Bitbucket-to-GitHub migration** and **GitHub Actions CI/CD standardization** based on the client’s internal **Paved Road** engineering standards.',
          'Audited legacy pre-cloud migration workflows, identified **deployment risks and architectural debt**, and refactored affected services before production migration to **reduce operational risk**.',
          'Authored a **standardized engineering onboarding guide** that was adopted as **mandatory client documentation**, improving knowledge transfer and onboarding consistency across engineering teams.',
        ],
        techStack: [
      ...
      },
      {
        ...
        points: [
          'Improved the Decisions Rule Engine Platform health score from **89% to 97%** by resolving platform issues, optimizing workflows, and improving code maintainability.',
          'Identified and replaced **commercially licensed dependencies** that introduced compliance risks, while establishing **clean-code and Decisions Platform best practices**.',
          'Built and supported **C#, SQL, Terraform, and AWS solutions** across application and infrastructure workloads, including deployments to **STG, QA, and Production**.',
          'Collaborated with Solution Architects, clients, vendors, and DevOps on **architecture decisions, technical spikes, code reviews**, production troubleshooting, and platform documentation.',
        ],
        techStack: ['C#', 'SQL', 'Terraform', 'AWS', 'Decisions Rule Engine', 'CI/CD Pipelines'],
      },
    ],
  },
  {
    ...
    points: [
      'Developed backend features using **ASP.NET Core, .NET, and Azure** across **2 training projects** within globally distributed Scrum delivery teams.',
      'Collaborated with senior engineers on **API development, testing, code reviews, and software delivery practices** while contributing to improvements in engineering workflows and **project onboarding documentation**.',
    ],
    techStack: [
      '.NET Core',
      'Microsoft Azure',
